...
import { S as SectionTitle } from "./SectionTitle-646f6067.mjs";
const _sfc_main = {
  __name: "FormSection",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="mt-5 md:mt-0 md:col-span-2"><form><div class="${ssrRenderClass([unref(hasActions) ? "sm:rounded-tl-md sm:rounded-tr-md" : "sm:rounded-md", "px-4 py-5 bg-white dark:bg-gray-800 sm:p-6 shadow"])}"><div class="grid grid-cols-6 gap-6">`);
